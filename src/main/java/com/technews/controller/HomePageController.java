...
public class HomePageController {
    ...
    @Autowired
    com.technews.repository.UserRepository userRepository;

    @Autowired
    com.technews.repository.PostRepository postRepository;

    @Autowired
    com.technews.repository.VoteRepository voteRepository;

    @Autowired
    com.technews.repository.CommentRepository commentRepository;
